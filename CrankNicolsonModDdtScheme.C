...
template<class Type>
scalar CrankNicolsonModDdtScheme<Type>::deltaT_() const
{
...
template<class Type>
scalar CrankNicolsonModDdtScheme<Type>::deltaT0_() const
{
...
scalar CrankNicolsonModDdtScheme<Type>::deltaT0_(const GeoField& vf) const
{
    if (vf.nOldTimes() < 2)
    {
        return great;
...
CrankNicolsonModDdtScheme<Type>::fvcDdt
(
...
template<class Type>
tmp<fvMatrix<Type>>
CrankNicolsonModDdtScheme<Type>::fvmDdt
(
    const GeometricField<Type, fvPatchField, volMesh>& vf
)
{
...
template<class Type>
tmp<typename CrankNicolsonModDdtScheme<Type>::fluxFieldType>
CrankNicolsonModDdtScheme<Type>::fvcDdtUfCorr
(
...
template<class Type>
tmp<typename CrankNicolsonModDdtScheme<Type>::fluxFieldType>
CrankNicolsonModDdtScheme<Type>::fvcDdtPhiCorr
(
    const GeometricField<Type, fvPatchField, volMesh>& U,
...
template<class Type>
tmp<surfaceScalarField> CrankNicolsonModDdtScheme<Type>::meshPhi
(
    const GeometricField<Type, fvPatchField, volMesh>& vf
)
{
